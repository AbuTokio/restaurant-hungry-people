...
export default function Header() {
  return (
    <header className="container mx-auto max-w-[1440px] bg-[url(/img/bg-header.png)] bg-cover">
      <section className="mx-auto pt-[25px] px-20 w-fit flex items-start gap-17.5 font-opensans text-white font-bold text-xs leading-4.5 uppercase">
        <Nav elements={[{ name: "Home", path: "/" }, { name: "Team" }]} />
        <img src="/img/logo.svg" alt="brand-logo" />
        <Nav elements={[{ name: "Menu" }, { name: "Booking" }]} />
      </section>

      <section className="mt-37.5 text-white border border-white flex">
        <div className="border">
          <p className="font-opensans font-bold text-xs border rotate-270 inline-block">
